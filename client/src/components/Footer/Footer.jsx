      ...
      <div className="top">
        ...
        <div className="footer-item">
          ...
          <span>
            ...
            labore ad quaerat fuga consectetur maiores facilis repudiandae quam.
          </span>
        </div>
        <div className="footer-item">
          ...
          <span>
            ...
            officia harum magni quam cum earum excepturi? Praesentium eum minus,
            recusandae debitis quidem esse dolorem tempora.
          </span>
        </div>
      </div>
